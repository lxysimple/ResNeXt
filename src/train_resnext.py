...
from lesson.H_ResNeXt.tools.cifar10_dataset import CifarDataset
from lesson.H_ResNeXt.tools.resnext_29 import ResNeXt29_2x64d
from lesson.H_ResNeXt.tools.common_tools import ModelTrainer, show_confMat, plot_line
...
if __name__ == "__main__":
    ...
    BATCH_SIZE = 0    #  1660ti 最大适合96，大家根据自己的设备情况进行设置batchsize
    LR = 0.1
    log_interval = 1
    val_interval = 1
    start_epoch = -1
